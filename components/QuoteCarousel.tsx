...
export default function QuoteCarousel({ quotes }: { quotes: Quote[] }) {
  ...
  return (
    <div
      className="rounded-2xl border border-white/20 bg-white/60 p-8 shadow-lg backdrop-blur-sm dark:border-slate-700 dark:bg-slate-800/60"
      role="region"
      aria-label="Inspiration quotes"
    >
      <blockquote className="text-center">
        ...
        <footer className="mt-4 text-lg text-slate-600 dark:text-slate-400">
          — {list[idx]?.by}
        </footer>
      </blockquote>
